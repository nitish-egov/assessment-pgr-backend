...
import digit.web.models.Idgen.IdResponse;
...
//    userService.callUserService(serviceRequest);
  ...
  /**
   * Enriches the search criteria in case of default search and enriches the userIds from
   * mobileNumber in case of seach based on mobileNumber. Also sets the default limit and offset if
   * none is provided
   *
   * @param requestInfo
   * @param criteria
   ...
   * @param idKey       code of the field defined in application properties for which ids are
   *                    generated for
